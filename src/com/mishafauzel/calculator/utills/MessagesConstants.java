...
// по сути обычный класс содержащий константы типа String
public class MessagesConstants {

    

    public static final String DATA_CONTAINS_UNACCEPTABLE_SYMBOLS="В строке присутсвуют неправильные знаки";
    public static final String NUMBER_TOO_BIG="Одно из чисел больше 10";
    ...
    public static final String CALCULATING="Считаем!!!";

    public static final String PRESS_ENTER_TO_EXIT = "Нажмите ENTER для выхода";
    public static final String ROMANS_DIDNT_HAVE_NUMBER_LESS_THEN_ONE="Извините, у римлян не было чисел меньше 1, поэтому мы не можем вам ничег показать(((";
}
